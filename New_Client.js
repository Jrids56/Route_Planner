...
function initAutocomplete() {
  ...
  autocomplete = new google.maps.places.Autocomplete(address1Field, {
    // restrict country search to australia
...
// Create a function which stores the address in the database on the table and saves when the page is refreshed
function saveAddress() {
    ...
    // Get the value of the locality field
